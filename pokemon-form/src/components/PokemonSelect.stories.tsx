...
// src/components/PokemonSelect.stories.tsx
import { Meta, StoryObj } from '@storybook/react';
import PokemonSelect from './PokemonSelect';
...
const meta: Meta<typeof PokemonSelect> = {
	...
	parameters: {
		docs: {
			description: {
				component: 'A select dropdown for choosing Pokémon, with search and validation.',
			},
		},
	},
};
...
export const Default: StoryObj<typeof PokemonSelect> = {
	args: {
		selectedPokemons: [],
		setSelectedPokemons: () => { },
	},
